...
def set_sound_output(inputs):
    """Sets the TV audio output using com.webos.service.audio.
    ...
    Valid outputs:
        ...
        usb_speaker1
    """
    endpoint = "luna://com.webos.service.audio/setSoundOutput"
    payload = {
        "soundOutput": inputs["soundOutput"]
    }
    luna_send(endpoint, payload)
